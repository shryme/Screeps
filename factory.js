    ...
    if (isBusDone(data.lazy_harvesterNumbers, data.busNumbers, data.listBus)) {
      //if (data.harvesterSmallestTimeToLive > 150) {
        ...
        if (data.guardNumbers >= 6 && Game.spawns.Spawn1) {
          Game.spawns.Spawn1.createCreep([Game.TOUGH, Game.TOUGH, Game.TOUGH, Game.TOUGH, Game.TOUGH, Game.MOVE, Game.ATTACK, Game.ATTACK, Game.ATTACK, Game.ATTACK], undefined, {role: 'guard'});
        }
