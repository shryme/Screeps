...
module.exports = {
  ...
  createRobotz: function(data) {
    ...
    if (lazyHarvesterFactory.isDone(data.lazy_harvesterNumbers, data.busNumbers, data.listBus, data.listHarvester)) {
        ...
        var extNumbers = Game.spawns.Spawn1.pos.findClosest(Game.MY_STRUCTURES, {filter: function(object) {return object.structureType === Game.STRUCTURE_EXTENSION && object.energy === object.energyCapacity} }).length;
        if (extNumbers > 0) {
